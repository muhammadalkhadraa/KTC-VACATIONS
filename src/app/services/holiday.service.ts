...
export class HolidayService {
  ...
  private readonly SELECT_ALL = 'request_id:request_id,emp_id:empId,emp_name:emp_name,start_date:startDate,end_date:end_date,days:days,reason:reason,status:status,manager_status:manager_status,manager_id:manager_id,gm_status:gm_status,gm_id:gm_id,submitted_at:submittedAt';
